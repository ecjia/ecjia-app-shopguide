		...
		<section class="panel">
        	<div class="panel-body">
		      	<ul id="validate_wizard-titles" class="stepy-titles clearfix">
		    		<li id="step1" class="{if $step eq 1}current-step{/if}"><div>设置基本信息</div><span class="m_t5">店铺名称、店铺信息等</span><span class="stepNb">1</span></li>
		    		<li id="step2" class="{if $step eq 2}current-step{/if}"><div>添加商品</div><span class="m_t5">选择平台分类、添加商品</span><span class="stepNb">2</span></li>
		    		<li id="step3" class="{if $step eq 3}current-step{/if}"><div>配送设置</div><span class="m_t5">设置店铺配送方式</span><span class="stepNb">3</span></li>
		    		<li id="step3" class="{if $step eq 4}current-step{/if}"><div>完成向导</div><span class="m_t5">恭喜您！店铺可以使用了</span><span class="stepNb">4</span></li>
		    	</ul>
				<form class="form-horizontal cmxform" id="default" action="{url path='shopguide/merchant/step_post'}{if $smarty.get.step}&step={$smarty.get.step}{/if}" method="post" name="theForm" enctype="multipart/form-data" data-toggle='from'>
				    ...
				    <fieldset class="step1">
				    	<div class="form-group"><h3 class="control-label col-lg-3">基本信息</h3></div>
				        ...
				        <div class="form-group">
							...
							<div class="shop-logo-content fileupload fileupload-{if $data.shop_logo}exists{else}new{/if}" data-provides="fileupload">
							    <div class="fileupload-preview thumbnail fileupload-exists shop_logo">
							        <img src="{if $data.shop_logo}{$data.shop_logo}{else}{$app_url}/shop-logo.png{/if}" />
							    </div>
							    <span class="text">推荐图片的尺寸为：512x512px</span>
							    <span class="btn btn-primary btn-file btn-sm">
							        <span class="fileupload-new"><i class="fa fa-paper-clip"></i> 选择Logo图</span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <div class="image-content fileupload fileupload-{if $data.shop_banner_pic}exists{else}new{/if}" data-provides="fileupload">
                                    <div class="fileupload-preview thumbnail fileupload-exists shop_banner_pic">
                                        <img src="{if $data.shop_banner_pic}{$data.shop_baner_pic}{else}{$app_url}/shop-logo.png{/if}" />
                                    </div>
                                    <span class="btn btn-primary btn-file btn-sm">
                        ...
                        <div class="form-group">
                       	...
                       	<div class="form-group">
                            ...
                            <div class="col-lg-6">
                            	<input class="form-control" type="text" name="shop_kf_mobile" />
                            </div>
                        </div>
				    ...
				    <fieldset class="step2">
				    	<div class="form-group"><h3 class="control-label col-lg-3">选择平台商品分类</h3></div>
						...
						<div class="form-group"><h3 class="control-label col-lg-3">添加商品</h3></div>
				    ...
				    <fieldset class="step3 step">
				    	<div class="form-group"><h3 class="control-label col-lg-3">配送信息<span class="color_838383 m_l10">可开启配送方式，启用之后，点击配送方式可设置配送区域，配送方式可设置多个。此项非必填项，您可选择暂时跳过此步骤。</span></h3></div>
				    	<ul class="step-ul">
						...
						<div class="color_838383 m_l54">温馨提示：配送方式安装完成后，请刷新此页面查看安装后效果。</div>
